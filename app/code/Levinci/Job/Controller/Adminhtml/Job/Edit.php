...
class Edit extends \Levinci\Job\Controller\Adminhtml\Job
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('levinci_job_job', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Job %1', $model->getId()) : __('New Job'));
        return $resultPage;
    }
}
